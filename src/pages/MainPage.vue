...
<template>
  <div class="container flex justify-between px-4 pt-8 m-auto">
    <div class="max-w-3xl">
      ...
      <RouterLink :to="{ name: 'MainPage' }" class="p-2 text-4xl rounded bg-primary hover:hue-rotate-60 hover:drop-shadow-[0rem_0rem_0.4rem_#0ff]">
        Let's get started...
      </RouterLink>
    </div>
    <div class="max-w-3xl bg-glow">
      <img
        ...
        draggable="false"
        alt="Asuka"
        class="overflow-y-hidden drop-shadow-[0rem_0rem_0.7rem_#fff]"
        :style="`transform: translate3D(${x / 120}px, 7px, 50px)`"
      >
    </div>
  </div>
</template>
